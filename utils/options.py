...
def parse_options_debug(root_path, data_type, is_train=True):
    ...
    if is_train:
        ...
        if data_type=='faust':
            ...
            # args.opt = 'options_mutil_scales/train/faust.yaml'
            # args.opt = 'options_mutil_scales/train/faust.yaml'
        ...
        if data_type=='smal':
            # args.opt = 'options_param/train/smal.yaml' 
            # args.opt = 'options/train/smal.yaml' 
            args.opt = 'options_two/train/smal.yaml'
            # args.opt = 'options_cont/train/smal.yaml'
            # args.opt = 'options_cont/train/smal.yaml'   
            # args.opt = 'options_cont/train/smal_spat.yaml' 
